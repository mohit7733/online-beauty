...
function Supplierpandingmeeting(props) {
    ...
    useEffect(() => {
        supplierTime.length > 0 &&
            axios
                .post(
                    api + "/api/v1/supplier-meeting-avaiblity",
                    supplierTime,
                    {
                        headers: {
                            Authorization:
    ...
    useEffect(() => {
        if (deleteId) {
            axios
                .get(
                    `${api}/api/v1/supplier-meeting-refused?meeting_id=${deleteId}`,
                    {
                        headers: {
                            Authorization:
                                "Bearer " + localStorage.getItem("token"),
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    Buyer Date / Time (
                                    {data !== undefined
                                        ? meetingDetails[0]?.buyerCountryCode
                                              .countrycode
                                        : ""}
                                    )
                                    {/* ({" "}
