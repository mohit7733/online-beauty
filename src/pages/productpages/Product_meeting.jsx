			...
			<div
				className={
					section == 3
						...
						section == 16
						? "product_showcase supplier_pending_wrap Meeting_wrap"
						: section == 17
						? "product_showcase supplier_pending_wrapper Meeting_wrap"
						: section == 18
						? "edit_remark Meeting_wrap"
						: section == 19
						? "product_showcase supplier_pending_wrap Meeting_wrap"
						: section == 20
						? "product_showcase supplier_pending_wrap Meeting_wrap"
						...
						? "edit_remark Meeting_wrap "
						: section == 23
						? "company_wrapper product_section "
						: section == 24
						? "product_before_meeting "
						: section == 6
			...
			>
				<div class="main">
					...
					{section == 2 ? (
						...
						<Pandingmeeting sidebar={sidebar} />
					) : section == 14 ? (
						<AcceptMeeting sidebar={sidebar} />
					) : section == 15 ? (
						<MeetingDone sidebar={sidebar} />
					) : section == 16 ? (
						<BuyerconfirmMetting sidebar={sidebar} />
					) : section == 17 ? (
						<BuyerpassedMeeting sidebar={sidebar} setsection={setsection} />
					) : section == 18 ? (
						<BuyerviewRemark sidebar={sidebar} setsection={setsection} />
					) : section == 19 ? (
						<Supplierpandingmeeting sidebar={sidebar} setsection={setsection} />
					) : section == 20 ? (
						<Supplierconfirmmeeting sidebar={sidebar} setsection={setsection} />
					) : section == 21 ? (
						<Supplierpassedmeeting sidebar={sidebar} setsection={setsection} />
					) : section == 22 ? (
						<SupplierviewRemark sidebar={sidebar} setsection={setsection} />
					) : section == 23 ? (
						<Company_information sidebar={sidebar} setsection={setsection} />
					) : section == 24 ? (
						<ProductBuyerSup sidebar={sidebar} setsection={setsection} />
					) : (
